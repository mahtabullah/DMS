                        ...
                        <div class="table-responsive">
                            <div class="portlet-body">
                                <div class="table-scrollable">
                                    <table class="table table-striped table-bordered table-hover table-full-width" id="outlettable">
                                        <thead>
                                            <tr>
                                            ...
                                            foreach ($outlet as $key) {
                                                ...
                                                <tr id="row_attr">
                                                    ...
                                                    <td class="center">                                       
                                                        ...
                                                        <!--                                                <button  class="btn btn-xs red" onclick="ConfirmationWindow('Delete',--><?php //echo '\''.base_url().'outlet/outletDeleteById/'.$key['outlet_id'].'\'';  ?>
